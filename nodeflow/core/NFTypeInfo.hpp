...
namespace nf {
	struct TypeInfo
	{
		...
		{
			return !(fundamentalInfo == FundamentalFlag::NonFundamental || fundamentalInfo == FundamentalFlag::Void || fundamentalInfo == FundamentalFlag::Nullptr_t);
		}

		constexpr bool isValidType() const noexcept
		{
			return !(fundamentalInfo == FundamentalFlag::Void || fundamentalInfo == FundamentalFlag::Nullptr_t);
		}
