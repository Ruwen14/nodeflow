...
protected:
	...
	{
		static_assert(NotImplemented<AbstractNodeStyle>::value,
			"method 'void pinShape(PinInfo info, NFPainter* painter)' not implemented. Override in derived");
	}
...
private:
	...
	const IMPL& impl() const { return *static_cast<IMPL const*>(this); }
...
class Style : public std::conditional_t<std::is_same_v<IMPL, void>, AbstractNodeStyle<Style<>>, AbstractNodeStyle<IMPL>>
{
